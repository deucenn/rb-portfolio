...
function Projects() {
  return (
    <section id="projects" className="text-gray-400 body-font relative">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            building innovative solutions, I'm passionate about bringing ideas
            to life with the help of JavaScript and React.
          </p>
        </div>
